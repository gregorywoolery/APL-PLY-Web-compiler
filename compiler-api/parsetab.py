...
_lr_productions = [
  ...
  ('start -> expression','start',1,'p_start','compile.py',120),
  ...
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_parenthesis','compile.py',182),
  ('empty -> <empty>','empty',0,'p_empty','compile.py',194),
]
